...
public class UIConstants {
    ...
    public static final String HEALTH_LABEL_2 = "Player 2 Health: ";
    public static final String SCORE_LABEL_2 = "Player 2 Score: ";
    ...
    public static final String SERVER_CONNECTED = "You have reached the multiplayer level and should wait for matchmaking...";
    public static final String MATCH_FOUND = "Match is found! You are playing with: ";
    public static final String CONNECTION_FAIL = "Failed to connect to the server.";

    public static final String SCORE = "'s Score: ";
    public static final String TOTAL_SCORE = "Total Score: ";
    public static final String GOT_BONUS = " BONUS points are applied to ";
    public static final String NO_BONUS = "Nobody could get the bonus points.";
